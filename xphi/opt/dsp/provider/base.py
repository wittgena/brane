# xphi.opt.dsp.provider.base
## @lineage: bound.xor.dsp.provider.base
## @lineage: xor.dsp.provider.base
## @lineage: bound.channel.bridge.dsp.provider.base
## @lineage: channel.bridge.dsp.provider.base
## @lineage: meta.xor.adapter.provider.base
## @lineage: meta.ops.provider.base
## @lineage: meta.ops.trainer.provider.base
from abc import abstractmethod
from concurrent.futures import Future
from threading import Thread
from typing import TYPE_CHECKING, Any
from xphi.opt.dsp.handler.train import TrainDataFormat
if TYPE_CHECKING:
