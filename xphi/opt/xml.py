...
from xphi.opt.chat import ChatAdapter, FieldInfoWithName
from xphi.opt.utils import format_field_value, translate_field_type
...
class XMLAdapter(ChatAdapter):
    ...
    def _parse_field_value(self, field_info, raw, completion, signature):
        from xphi.opt.utils import parse_value
