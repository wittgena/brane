# xphi.xor.opt.exam.example
## @lineage: xphi.opt.exam.example
## @lineage: bound.xor.exam.example
## @lineage: xor.exam.example
## @lineage: anchor.xor.exam.example
## @lineage: meta.xor.adapter.exam.example
## @lineage: xor.adapter.exam.example
## @lineage: xor.dsp.adapter.exam.example
    ...
    def toDict(self):  # noqa: N802
        def convert_to_serializable(value):
            if hasattr(value, "toDict"):
                ...
                # Handle Pydantic models (e.g., spi.History)
