# xphi.xor.secret.diff
## @lineage: bound.xor.secret.diff
## @lineage: xor.secret.diff
## @lineage: bound.channel.secret.diff
## @lineage: channel.secret.diff
## @lineage: meta.ops.observer.security.secret.diff
