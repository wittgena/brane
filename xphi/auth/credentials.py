# xphi.auth.credentials
## @lineage: bound.auth.credentials
## @lineage: xphi.agent.manager.auth.credentials
## @lineage: anchor.agent.manager.auth.credentials
## @lineage: gov.sandbox.security.auth.credentials
