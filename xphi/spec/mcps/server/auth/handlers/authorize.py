# xphi.spec.mcps.server.auth.handlers.authorize
## @lineage: xphi.spec.mcp.server.auth.handlers.authorize
import logging
...
from xphi.spec.mcps.server.auth.provider import (
...
from xphi.spec.mcps.shared.auth import InvalidRedirectUriError, InvalidScopeError
