# xphi.spec.mcps.server.auth.handlers.register
## @lineage: xphi.spec.mcp.server.auth.handlers.register
import secrets
import time
...
from xphi.spec.mcps.server.auth.errors import stringify_pydantic_error
from xphi.spec.mcps.server.auth.json_response import PydanticJSONResponse
from xphi.spec.mcps.server.auth.provider import OAuthAuthorizationServerProvider, RegistrationError, RegistrationErrorCode
from xphi.spec.mcps.server.auth.settings import ClientRegistrationOptions
from xphi.spec.mcps.shared.auth import OAuthClientInformationFull, OAuthClientMetadata
