# xphi.spec.mcps.server.auth.provider
## @lineage: xphi.spec.mcp.server.auth.provider
...
from xphi.spec.mcps.shared.auth import OAuthClientInformationFull, OAuthToken
