# xphi.spec.mcps.server.auth.routes
...
from xphi.spec.mcps.server.auth.handlers.authorize import AuthorizationHandler
from xphi.spec.mcps.server.auth.handlers.metadata import MetadataHandler, ProtectedResourceMetadataHandler
from xphi.spec.mcps.server.auth.handlers.register import RegistrationHandler
from xphi.spec.mcps.server.auth.handlers.revoke import RevocationHandler
from xphi.spec.mcps.server.auth.handlers.token import TokenHandler
from xphi.spec.mcps.server.auth.middleware.client_auth import ClientAuthenticator
from xphi.spec.mcps.server.auth.provider import OAuthAuthorizationServerProvider
from xphi.spec.mcps.server.auth.settings import ClientRegistrationOptions, RevocationOptions
from xphi.spec.mcps.server.streamable_http import MCP_PROTOCOL_VERSION_HEADER
from xphi.spec.mcps.shared.auth import OAuthMetadata, ProtectedResourceMetadata
