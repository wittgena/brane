# xphi.spec.mcps.client.session_group
...
import xphi.spec.mcps
from xphi.spec.mcps import types
from xphi.spec.mcps.client.session import ElicitationFnT, ListRootsFnT, LoggingFnT, MessageHandlerFnT, SamplingFnT, ClientSession
from xphi.spec.mcps.client.sse import sse_client
from xphi.spec.mcps.client.stdio import stdio_client
from xphi.spec.mcps.client.stdio import StdioServerParameters
from xphi.spec.mcps.client.streamable_http import streamable_http_client
from xphi.spec.mcps.shared._httpx_utils import create_mcp_http_client
from xphi.spec.mcps.shared.exceptions import MCPError
from xphi.spec.mcps.shared.session import ProgressFnT
...
class ClientSessionGroup:
    ...
    async def connect_with_session(
        self, server_info: types.Implementation, session: ClientSession
    ) -> ClientSession:
    ...
    ) -> tuple[types.Implementation, ClientSession]:
    ...
    async def _aggregate_components(self, server_info: types.Implementation, session: ClientSession) -> None:
