# xphi.server.auth.routes
## @lineage: bound.server.auth.routes
...
from xphi.server.stream.http import MCP_PROTOCOL_VERSION_HEADER

from xphi.server.auth.handlers.authorize import AuthorizationHandler
from xphi.server.auth.handlers.metadata import MetadataHandler, ProtectedResourceMetadataHandler
from xphi.server.auth.handlers.register import RegistrationHandler
from xphi.server.auth.handlers.revoke import RevocationHandler
from xphi.server.auth.handlers.token import TokenHandler
from xphi.server.auth.middleware.client_auth import ClientAuthenticator
from xphi.server.auth.provider import OAuthAuthorizationServerProvider
from xphi.server.auth.settings import ClientRegistrationOptions, RevocationOptions
