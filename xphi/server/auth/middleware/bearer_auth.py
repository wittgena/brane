# xphi.server.auth.middleware.bearer_auth
## @lineage: bound.server.auth.middleware.bearer_auth
## @lineage: bound.server.adapter.auth.middleware.bearer_auth
## @lineage: bound.adapter.mcps.server.auth.middleware.bearer_auth
## @lineage: anchor.surface.mcps.server.auth.middleware.bearer_auth
## @lineage: bound.server.mcps.auth.middleware.bearer_auth
## @lineage: xphi.spec.mcps.server.auth.middleware.bearer_auth
## @lineage: xphi.spec.mcp.server.auth.middleware.bearer_auth
import json
import time
...
from xphi.server.auth.provider import AccessToken, TokenVerifier
