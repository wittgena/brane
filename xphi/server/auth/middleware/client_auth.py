# xphi.server.auth.middleware.client_auth
## @lineage: bound.server.auth.middleware.client_auth
## @lineage: bound.server.adapter.auth.middleware.client_auth
## @lineage: bound.adapter.mcps.server.auth.middleware.client_auth
## @lineage: anchor.surface.mcps.server.auth.middleware.client_auth
## @lineage: bound.server.mcps.auth.middleware.client_auth
## @lineage: xphi.spec.mcps.server.auth.middleware.client_auth
## @lineage: xphi.spec.mcp.server.auth.middleware.client_auth
import base64
import binascii
import hmac
import time
