# xphi.server.auth.handlers.register
## @lineage: bound.server.auth.handlers.register
...
from xphi.server.auth.provider import OAuthAuthorizationServerProvider, RegistrationError, RegistrationErrorCode
from xphi.server.auth.settings import ClientRegistrationOptions
