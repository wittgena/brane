# xphi.server.auth.xphi.extensions.client_credentials
## @lineage: bound.server.xphi.auth.extensions.client_credentials
## @lineage: xphi.server.auth.extensions.client_credentials
## @lineage: bound.adapter.mcps.auth.extensions.client_credentials
## @lineage: xphi.mcps.client.auth.extensions.client_credentials
## @lineage: mcps.client.auth.extensions.client_credentials
## @lineage: anchor.surface.mcpserver.client.auth.extensions.client_credentials
...
from xphi.server.auth.xphi.oauth2 import OAuthClientProvider, TokenStorage
from xphi.server.auth.xphi.exceptions import OAuthFlowError, OAuthTokenError
