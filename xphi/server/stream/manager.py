# xphi.server.stream.manager
## @lineage: bound.server.stream.manager
## @lineage: bound.adapter.mcps.stdio.streamable_http_manager
## @lineage: anchor.surface.mcps.stdio.streamable_http_manager
## @lineage: bound.server.mcps.streamable_http_manager
## @lineage: xphi.spec.mcps.server.streamable_http_manager
## @lineage: xphi.spec.mcp.server.streamable_http_manager
...
from xphi.server.auth.middleware.bearer_auth import AuthenticatedUser, AuthorizationContext, authorization_context
from xphi.server.stream.http import (
