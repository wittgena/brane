# xphi.adapter.provider.embedding
## @lineage: bound.adapter.provider.embedding
"""
...
from xphi.adapter.provider.base import BaseProviderAdapter
from anchor.channel.action.preprocessor import EmbeddingContext
from xphi.trans.embedding.router import EmbeddingRouter
