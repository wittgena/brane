# xphi.adapter.llama.output_parsers.selection
## @lineage: bound.adapter.llama.output_parsers.selection
## @lineage: bound.adapter.output_parsers.selection
## @lineage: anchor.adapter.output_parsers.selection
import json
from dataclasses import dataclass
from typing import Any, List

from dataclasses_json import DataClassJsonMixin
from xphi.adapter.llama.output_parsers.base import (
    OutputParserException,
    StructuredOutput,
)
from xphi.adapter.llama.output_parsers.utils import _marshal_llm_to_json
