# xphi.adapter.llama.output_parsers.pydantic
## @lineage: bound.adapter.llama.output_parsers.pydantic
## @lineage: bound.adapter.output_parsers.pydantic
## @lineage: anchor.adapter.output_parsers.pydantic
"""Pydantic output parser."""

import json
from typing import Any, Generic, List, Optional, Type

from xphi.adapter.llama.output_parsers import BaseOutputParser
from xphi.adapter.llama.output_parsers.utils import extract_json_str
