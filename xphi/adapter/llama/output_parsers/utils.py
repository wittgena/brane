# xphi.adapter.llama.output_parsers.utils
## @lineage: bound.adapter.llama.output_parsers.utils
...
from xphi.adapter.llama.output_parsers.base import OutputParserException
