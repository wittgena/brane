# xphi.adapter.llama.constants
## @lineage: bound.adapter.llama.constants
## @lineage: bound.adapter.constants
## @lineage: anchor.adapter.constants
## @lineage: bridge.llama.core.constants
"""Set of constants."""
