# xphi.adapter.llama.base.embeddings.base
## @lineage: bound.adapter.llama.base.embeddings.base
...
from xphi.adapter.llama.schema import BaseNode, MetadataMode, TransformComponent
from xphi.adapter.llama.utils import get_tqdm_iterable
from xphi.adapter.llama.async_utils import run_jobs
...
class BaseEmbedding(TransformComponent, DispatcherSpanMixin):
    ...
    def check_base_embeddings_class(self) -> Self:
        from xphi.adapter.llama.storage.kvstore.types import BaseKVStore
