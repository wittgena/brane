# xphi.adapter.llama.base.embeddings.base_sparse
## @lineage: bound.adapter.llama.base.embeddings.base_sparse
...
from xphi.adapter.llama.constants import DEFAULT_EMBED_BATCH_SIZE
