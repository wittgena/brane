# xphi.adapter.llama.base.llms.types
## @lineage: bound.adapter.llama.base.llms.types
...
from xphi.adapter.llama.schema import ImageDocument
from xphi.adapter.llama.utils import get_tokenizer, resolve_binary
...
class BaseContentBlock(ABC, BaseModel):
    ...
    def get_template_vars(self) -> list[str]:
        ...
        """
        from xphi.adapter.llama.prompts.utils import get_template_vars
    ...
    def format_vars(self, **kwargs: Any) -> "BaseContentBlock":
        ...
        For that to work, the validation on those fields would need to be updated though.
        """
        from xphi.adapter.llama.prompts.utils import format_string
...
class TextBlock(BaseContentBlock):
    ...
    async def asplit(
        ...
        from xphi.adapter.llama.node_parser import TokenTextSplitter
