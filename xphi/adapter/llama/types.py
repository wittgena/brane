# xphi.adapter.llama.types
## @lineage: bound.adapter.llama.types
## @lineage: bound.adapter.types
## @lineage: anchor.adapter.types
import threading
...
from xphi.adapter.llama.base.llms.types import ChatMessage, MessageRole, TextBlock
from xphi.adapter.llama.bridge.pydantic import (
    BaseModel,
    GetCoreSchemaHandler,
    GetJsonSchemaHandler,
)
from xphi.adapter.llama.bridge.pydantic_core import CoreSchema, core_schema
