# xphi.adapter.llama.utilities.sql_wrapper
## @lineage: bound.adapter.llama.utilities.sql_wrapper
## @lineage: bound.adapter.utilities.sql_wrapper
## @lineage: anchor.adapter.utilities.sql_wrapper
## @lineage: bridge.llama.core.utilities.sql_wrapper
## @lineage: channel.llama.core.utilities.sql_wrapper
