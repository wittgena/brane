# xphi.adapter.llama.utilities.aws_utils
## @lineage: bound.adapter.llama.utilities.aws_utils
## @lineage: bound.adapter.utilities.aws_utils
## @lineage: anchor.adapter.utilities.aws_utils
## @lineage: bridge.llama.core.utilities.aws_utils
