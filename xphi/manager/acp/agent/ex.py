# xphi.manager.acp.agent.ex
## @lineage: acps.gena.ex.agent
## @lineage: acps.examples.agent
import asyncio
import logging
from typing import Any
from anchor.spec.acp.bound.meta import PROTOCOL_VERSION
from anchor.spec.acp.bound.surface.interfaces import Agent
from anchor.spec.acp.bound.surface.schema import AuthenticateResponse, InitializeResponse, LoadSessionResponse, NewSessionResponse, PromptResponse, SetSessionModeResponse
from anchor.spec.acp.bound.stdio.agent import run_agent
from anchor.spec.acp.bound.helper import update_agent_message, text_block
from anchor.spec.acp.bound.surface.interfaces import Client
from anchor.spec.acp.bound.surface.schema import (
    AgentCapabilities,
    AgentMessageChunk,
    AudioContentBlock,
    ClientCapabilities,
