# xphi.manager.acp.client.exam
## @lineage: acps.gena.ex.client
...
from anchor.spec.acp.bound.stdio.agent import connect_to_agent
from anchor.spec.acp.bound.helper import text_block
from anchor.spec.acp.bound.surface.interfaces import Client
from anchor.spec.acp.bound.meta import PROTOCOL_VERSION


from anchor.spec.acp.bound.stdio.agent import ClientSideConnection
...
log = get_emitter("exam.client")


class ExamClient(Client):
