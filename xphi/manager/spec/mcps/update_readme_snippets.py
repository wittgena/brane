# xphi.manager.spec.mcps.update_readme_snippets
## @lineage: xphi.spec.mcps.scripts.update_readme_snippets
## @lineage: xphi.spec.mcp.scripts.update_readme_snippets
#!/usr/bin/env python3
