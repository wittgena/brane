# xphi.manager.spec.acps.client.exam
## @lineage: xphi.manager.acp.client.exam
...
from bound.server.acps.bound.stdio.agent import connect_to_agent
from bound.server.acps.bound.helper import text_block
from anchor.surface.acps.interfaces import Client
from bound.server.acps.bound.meta import PROTOCOL_VERSION


from bound.server.acps.bound.stdio.agent import ClientSideConnection
