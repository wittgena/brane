# xphi.manager.spec.acps.gena.signature
## @lineage: xphi.manager.acp.gena.signature
...
import anchor.surface.acps.schema as schema
...
class NodeTransformer(ast.NodeTransformer):
    ...
    def _format_annotation(self, annotation: t.Any) -> ast.expr:
        if t.get_origin(annotation) is t.Literal and annotation in self._literals.values():
            ...
            # [자연스러운 동작] 명시적 import를 사용했으므로 schema.__name__ 은 정상적인 모듈 FQN과 일치하게 됩니다.
