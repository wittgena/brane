# xphi.loop.inst.span_handlers.simple
## @lineage: bound.adapter.llama.instrumentation.span_handlers.simple
## @lineage: bound.adapter.instrumentation.span_handlers.simple
## @lineage: anchor.adapter.instrumentation.span_handlers.simple
## @lineage: bridge.llama.core.instrumentation.span_handlers.simple
import inspect
import warnings
from datetime import datetime
from functools import reduce
from typing import TYPE_CHECKING, Any, Dict, List, Optional, cast
from xphi.loop.inst.span.simple import SimpleSpan
from xphi.loop.inst.span_handlers.base import BaseSpanHandler
