# xphi.loop.flow.embedding.pooling
## @lineage: xphi.flow.embedding.pooling
## @lineage: bound.adapter.llama.embeddings.pooling
## @lineage: bound.adapter.embeddings.pooling
## @lineage: anchor.adapter.embeddings.pooling
