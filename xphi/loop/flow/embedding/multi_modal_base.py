# xphi.loop.flow.embedding.multi_modal_base
## @lineage: xphi.flow.embedding.multi_modal_base
## @lineage: bound.adapter.llama.embeddings.multi_modal_base
## @lineage: bound.adapter.embeddings.multi_modal_base
## @lineage: anchor.adapter.embeddings.multi_modal_base
