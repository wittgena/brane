# xphi.loop.flow.embedding.mock_embed_model
## @lineage: xphi.flow.embedding.mock_embed_model
## @lineage: bound.adapter.llama.embeddings.mock_embed_model
## @lineage: bound.adapter.embeddings.mock_embed_model
## @lineage: anchor.adapter.embeddings.mock_embed_model
