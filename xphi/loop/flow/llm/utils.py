# xphi.loop.flow.llm.utils
## @lineage: xphi.flow.llm.utils
## @lineage: bound.adapter.llama.llms.utils
## @lineage: bound.adapter.llms.utils
## @lineage: anchor.adapter.llms.utils
...
from xphi.loop.flow.llm.callbacks import CallbackManager
...
def resolve_llm(
    ...
    if llm == "default":
        ...
        if os.getenv("IS_TESTING"):
            from xphi.loop.flow.llm.mock import MockLLM
