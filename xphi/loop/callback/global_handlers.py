# xphi.loop.callback.global_handlers
## @lineage: bound.adapter.llama.callbacks.global_handlers
## @lineage: bound.adapter.callbacks.global_handlers
## @lineage: anchor.adapter.callbacks.global_handlers
from typing import Any, Optional
from xphi.loop.callback.base_handler import BaseCallbackHandler
from xphi.loop.callback.simple_llm_handler import SimpleLLMHandler


def set_global_handler(eval_mode: str, **eval_params: Any) -> None:
    """Set global eval handlers."""
    import xphi.adapter.llama
