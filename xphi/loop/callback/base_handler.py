# xphi.loop.callback.base_handler
## @lineage: bound.adapter.llama.callbacks.base_handler
## @lineage: bound.adapter.callbacks.base_handler
## @lineage: anchor.adapter.callbacks.base_handler
import logging
from abc import ABC, abstractmethod
from contextvars import ContextVar
from typing import Any, Dict, List, Optional
from xphi.loop.callback.schema import BASE_TRACE_EVENT, CBEventType
