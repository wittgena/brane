# xphi.loop.prog.utils
## @lineage: bound.adapter.llama.program.utils
    ...
    **kwargs: Any,
    ...
    if pydantic_program_mode == PydanticProgramMode.DEFAULT:
        if llm.metadata.is_function_calling_model:
            from xphi.loop.prog.function_program import FunctionCallingProgram
            ...
            from xphi.loop.prog.llm_program import (
        ...
        from xphi.loop.prog.llm_program import LLMTextCompletionProgram
