# xphi.trans.reader.route
## @lineage: xphi.flow.reader.route
## @lineage: xphi.flow.route.reader
## @lineage: xphi.flow.route.data
import os
import importlib
import inspect
from pathlib import Path
from typing import Dict, Any, List, Optional
from xphi.trans.reader.scan import ReaderScanner

DEFAULT_REGISTRY = {
    "pdf": {
        "module": "bound.inter.readers.file.pymu_pdf.base",
        "type": "file",
        "tags": ["pdf", "document", "text extract"]
    },
    "markdown": {
        "module": "bound.inter.readers.file.markdown.base",
        "type": "file",
        "tags": ["md", "markdown"]
    },
    "html_bs": {
        "module": "bound.inter.readers.web.beautiful_soup_web.base",
        "type": "web",
        "tags": ["html", "web", "url", "scraping"]
    },
    "sitemap": {
        "module": "bound.inter.readers.web.sitemap.base",
        "type": "web",
        "tags": ["sitemap", "xml", "crawler"]
    },
    "rss": {
        "module": "bound.inter.readers.web.rss.base",
        "type": "web",
        "tags": ["rss", "news", "feed"]
    }
}
...
class DataRouter:
    def __init__(self, readers_base_path: str = "bound/inter/readers"):
