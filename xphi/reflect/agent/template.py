# xphi.reflect.agent.template
## @lineage: bound.agent.reflector.template
## @lineage: xphi.agent.reflector.template
## @lineage: anchor.agent.reflector.template
## @lineage: agent.reflector.critic.template
...
class ChatTemplateRenderer:
    ...
    - This class can dynamically load templates from HuggingFace Hub or use provided templates directly.
    """
