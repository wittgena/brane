# xphi.reflect.server.router.auth
## @lineage: xphi.server.router.auth
...
from xphi.reflect.server.handle.auth import SimpleOAuthProvider
from xphi.reflect.server.setting import AuthServerSettings, default_auth_settings
