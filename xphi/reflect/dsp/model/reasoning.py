# xphi.reflect.dsp.model.reasoning
## @lineage: xphi.opt.dsp.model.reasoning
## @lineage: bound.xor.dsp.model.reasoning
## @lineage: xor.dsp.model.reasoning
...
## @lineage: meta.xor.adapter.manifold.reasoning
...
class Reasoning(Type):
    """Reasoning type in psi.

    This type is useful when you want the psi output to include the reasoning of the LM. We build this type so that
    psi can support the reasoning model and non-reasoning model with the same code.

    This is a str-like type, you can convert a string directly to a Reasoning object, and from adapters'
