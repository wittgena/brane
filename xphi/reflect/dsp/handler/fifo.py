# xphi.reflect.dsp.handler.fifo
## @lineage: xphi.opt.dsp.handler.fifo
## @lineage: bound.xor.dsp.handler.fifo
## @lineage: xor.dsp.handler.fifo
...
## @lineage: gate.io.resource.fifo
## @lineage: channel.resource.fifo
## @lineage: gov.medium.io.resource.fifo
## @lineage: gov.io.resource.fifo
"""
