# xphi.reflect.dsp.handler.stream.listener
## @lineage: xphi.opt.dsp.stream.listener
import inspect
import re
...
class StreamListener:
    ...
    def receive(self, chunk: Any):
        ...
        chunk_message = extract_stream_content(chunk)
