# xphi.reflect.dsp.handler.train
## @lineage: xphi.opt.dsp.handler.train
## @lineage: bound.xor.dsp.handler.train
## @lineage: xor.dsp.handler.train
...
from xphi.reflect.dsp.hasher import Hasher
...
def create_subdir_in_cachedir(subdir: str) -> str:
    subdir = os.path.join(SPI_CACHEDIR, subdir)
