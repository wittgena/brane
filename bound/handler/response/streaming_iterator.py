# bound.handler.response.streaming_iterator
## @lineage: channel.bound.handler.response.streaming_iterator
## @lineage: gate.bound.handler.response.streaming_iterator
