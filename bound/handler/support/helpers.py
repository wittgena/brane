...
from bound.router.model.types.llms.openai import AllMessageValues, OpenAIChatCompletionFinishReason
if TYPE_CHECKING:
...
def process_response_headers(response_headers: Union[httpx.Headers, dict]) -> dict:
    from bound.router.model.types.utils import OPENAI_RESPONSE_HEADERS
