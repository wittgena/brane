...
from bound.router.model.types.llms.openai import ChatCompletionAssistantContentValue, ChatCompletionAudioDelta
...
from bound.router.model.types.llms.openai import ChatCompletionRedactedThinkingBlock, ChatCompletionThinkingBlock
