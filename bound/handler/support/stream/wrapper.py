...
from xphi.rule.validator import Rules
from anchor.switch.params import ModelResponse, ModelResponseStream, StreamingChoices, Usage

from bound.handler.support.stream.response.check import is_model_response_stream_empty
from bound.handler.support.helpers import map_finish_reason, process_response_headers
from anchor.mapping.exception import exception_type
from bound.channel.model.types.llms.openai import OpenAIChatCompletionChunk
...
from bound.channel.model.types.utils import Delta, CallTypes, GenericStreamingChunk as GChunk
...
class CustomStreamWrapper:
    ...
    def return_processed_chunk_logic(  # noqa
        ...
        from bound.handler.support.helpers import (
    ...
    def chunk_creator(self, chunk: Any):  # type: ignore  # noqa: PLR0915
        ...
        try:
            ...
            from bound.channel.model.types.utils import GenericStreamingChunk as GChunk
...
def convert_generic_chunk_to_model_response_stream(
    ...
    from bound.channel.model.types.utils import Delta
