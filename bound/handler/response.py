...
from bound.handler.support.template import update_responses_input_with_model_file_ids, update_responses_tools_with_model_file_ids
...
def _responses_try_dispatch_emulated_file_search(
    *,
    ...
    from bound.channel.router.search.file import aresponses_with_emulated_file_search
