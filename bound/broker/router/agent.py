# bound.broker.router.agent
## @lineage: bound.adapter.broker.router.agent
## @lineage: acps.broker.router.agent
## @lineage: acps.connection.handler.agent
## @lineage: channel.acps.connection.handler.agent
## @lineage: bound.server.acps.connection.handler.agent
## @lineage: anchor.spec.acp.connection.handler.agent
## @lineage: xphi.spec.acp.connection.handler.agent
## @lineage: acps.agent.router
...
from bound.broker.router.message import MessageRouter, Route, _resolve_handler, _warn_legacy_handler
...
from bound.broker.model import model_to_kwargs, normalize_result
