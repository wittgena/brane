# bound.broker.router.message
## @lineage: bound.adapter.broker.router.message
## @lineage: acps.broker.router.message
## @lineage: acps.message.router
## @lineage: channel.acps.message.router
## @lineage: bound.server.acps.message.router
## @lineage: anchor.spec.acp.message.router
## @lineage: xphi.spec.acp.message.router
## @lineage: acps.router
...
from bound.broker.model import to_camel_case
