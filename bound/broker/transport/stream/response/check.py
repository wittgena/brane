# bound.broker.transport.stream.response.check
## @lineage: bound.channel.transport.stream.response.check
## @lineage: bound.transport.stream.response.check
## @lineage: bound.bridge.stream.response.check
## @lineage: bound.client.handler.stream.response.check
...
from anchor.surface.legacy.llm.types.utils import Delta, ModelResponseBase, ModelResponseStream
