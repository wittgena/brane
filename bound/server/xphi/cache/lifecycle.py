# bound.server.xphi.cache.lifecycle
## @lineage: xphi.server.cache.lifecycle
## @lineage: bound.server.cache.lifecycle
## @lineage: bound.proxy.cache.lifecycle
## @lineage: anchor.router.cache.lifecycle
## @lineage: bound.router.cache.lifecycle
