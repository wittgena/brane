# bound.agent.option.common
## @lineage: xphi.agent.manager.option.common
## @lineage: anchor.agent.manager.option.common
## @lineage: agent.manager.option.common
## @lineage: gov.lango.manager.setting.common
