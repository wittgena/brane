# bound.channel.model.provider.resolver
...
from anchor.config.constants import REPLICATE_MODEL_NAME_WITH_ID_LENGTH
from bound.channel.model.types.router import LiteLLM_Params
from bound.channel.secret.manager import get_secret_str, get_secret 
from watcher.plane.emitter import get_emitter
from bound.channel.model.provider.logic import (
...
class LLMProviderResolver:
    ...
    def _resolve_special_cases(self, model: str, custom_llm_provider: Optional[str]) -> Tuple[str, Optional[str], bool]:
        from bound.channel.model.cost.map import get_provider_for_model
    ...
    def _resolve_by_model_name(self, model: str, custom_llm_provider: Optional[str]) -> Tuple[str, Optional[str]]:
        from bound.channel.model.cost.model import get_provider_for_model
