# bound.channel.model.types.llms.gemini
## @lineage: channel.model.types.llms.gemini
## @lineage: anchor.model.types.llms.gemini
## @lineage: gate.model.types.llms.gemini
## @lineage: gate.types.llms.gemini
## @lineage: blm.types.llms.gemini
## @lineage: gov.blm.types.llms.gemini
from enum import Enum
from typing import Any, Dict, List, Literal, Optional
from typing_extensions import Required, TypedDict
from bound.channel.model.types.llms.vertex_ai import (
    GenerationConfig,
    HttpxBlobType,
    HttpxContentType,
    Tools,
