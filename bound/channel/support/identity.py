# bound.channel.support.identity
...
from anchor.surface.legacy.llm.types.response import DecodedResponseId
from anchor.surface.legacy.llm.types.utils import SpecialEnums
