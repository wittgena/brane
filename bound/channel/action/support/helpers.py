# bound.channel.action.support.helpers
...
from bound.adapter.legacy.llm.openai.types import AllMessageValues, OpenAIChatCompletionFinishReason
if TYPE_CHECKING:
...
def process_response_headers(response_headers: Union[httpx.Headers, dict]) -> dict:
    from bound.adapter.legacy.llm.types.utils import OPENAI_RESPONSE_HEADERS
