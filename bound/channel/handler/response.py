...
from bound.channel.handler.support.template import update_responses_input_with_model_file_ids, update_responses_tools_with_model_file_ids
from bound.channel.client.wrapper import client
from bound.channel.handler.support.utils import ResponsesAPIRequestUtils
from bound.channel.handler.api import ResponseApiHandler
...
from bound.router.model.types.responses.main import *
...
from bound.router.model.types.llms.openai import ResponseText
...
def _responses_try_dispatch_emulated_file_search(
    *,
    ...
    from bound.router.search.file import aresponses_with_emulated_file_search
