# bound.channel.client.action.api.response
...
from bound.channel.client.response.template import update_responses_input_with_model_file_ids, update_responses_tools_with_model_file_ids
...
class ResponsesDispatcher:
    ...
    def _dispatch_mcp(self) -> Optional[Any]:
        ...
        if self.ctx.is_async:
            from bound.channel.client.action.api.aresponse import aresponses_api_with_mcp
    ...
    def _dispatch_file_search(self) -> Optional[Any]:
        from bound.channel.client.action.support.search.file import aresponses_with_emulated_file_search
