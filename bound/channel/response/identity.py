# bound.channel.response.identity
## @lineage: bound.channel.support.identity
## @lineage: bound.adapter.litellm.support.identity
## @lineage: bound.legacy.support.identity
## @lineage: bound.client.support.identity
## @lineage: bound.handler.identity
import base64
import re
from typing import (
    Any,
...
from bound.adapter.legacy.mcp.header import MCPHeaderParser
from bound.adapter.legacy.llm.types.response import DecodedResponseId
from bound.adapter.legacy.llm.types.utils import SpecialEnums
