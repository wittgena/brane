# bound.channel.bridge.action.preprocessor
...
from anchor.surface.legacy.llm.openai.types import AllMessageValues
from bound.channel.support.param.optional import get_optional_params
from bound.channel.support.param.litellm import get_litellm_params
from bound.channel.support.param.validator import (
...
class EmbeddingPreprocessor:
    ...
    def build(self) -> EmbeddingContext:
        ...
        from bound.channel.support.param.embedding import get_optional_params_embeddings
