# bound.channel.config.response
## @lineage: anchor.channel.config.response
## @lineage: anchor.channel.response.config
## @lineage: bound.channel.response.config
## @lineage: bound.channel.support.response.config
## @lineage: anchor.action.response.config
