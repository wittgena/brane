# bound.channel.config.constants
## @lineage: anchor.channel.config.constants
## @lineage: anchor.switch.config.constants
...
## @lineage: anchor.base.constants
## @lineage: gov.gate.constants
## @lineage: gate.constants
## @lineage: blm.constants
## @lineage: gov.blm.constants
import os
import sys
...
DEFAULT_HEALTH_CHECK_PROMPT = str(
    os.getenv("DEFAULT_HEALTH_CHECK_PROMPT", "test self")
)
