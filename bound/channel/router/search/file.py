# bound.channel.router.search.file
## @lineage: anchor.router.search.file
import json
import time
from typing import Any, Dict, Iterable, List, Optional, Tuple, Union, cast
from bound.handler.aresponse import aresponses
from bound.channel.model.types.llms.openai import ResponseOutputItem, ResponsesAPIResponse
from bound.channel.model.types.vector_stores import VectorStoreSearchResult
