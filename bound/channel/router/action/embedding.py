# bound.channel.router.action.embedding
## @lineage: anchor.router.action.embedding
import asyncio
import contextvars
import datetime
import inspect
...
from bound.channel.model.types.utils import all_litellm_params, EmbeddingResponse
...
from bound.channel.router.action.param.embedding import get_optional_params_embeddings
...
from bound.channel.bridge.llms.openai.embedding import OpenAIEmbedding
from bound.channel.secret.manager import get_secret, get_secret_str
