# bound.channel.router.action.acompletion
...
from bound.channel.model.types.llms.openai import ChatCompletionAudioParam, ChatCompletionModality, ChatCompletionPredictionContentParam, OpenAIWebSearchOptions
from anchor.exceptions import Timeout
