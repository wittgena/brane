# bound.module.meta
## @lineage: meta.watcher.scope.module.meta
## @lineage: meta.watcher.frame.scope.module.meta
## @lineage: frame.scope.module.meta
import inspect
import logging
...
from anchor.xor.exam.example import Example
from anchor.xor.exam.prediction import Prediction

from bound.module.base import BaseModule
...
from bound.module.runner import ParallelRunner
