...
from bound.legacy.proxy.reverse import global_mcp_server_manager, LegacyLitellmToolsManager
from bound.legacy.proxy.logger import LegacyLitellmLogManager
from bound.legacy.mcp.tool import transform_mcp_tool_to_openai_responses_api_tool, transform_mcp_tool_to_openai_tool
...
class MCPProxyHandler:
    ...
    def _create_tool_execution_events(
        ...
        for tool_result in tool_results:
            ...
            from bound.legacy.mcp.stream import create_mcp_call_events
    ...
    def _create_mcp_streaming_response(
        ...
        **kwargs,
        ...
        from bound.legacy.mcp.stream import MCPEnhancedStreamingIterator
