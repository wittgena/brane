# bound.router.acp.agent
## @lineage: bound.bridge.router.agent
...
from bound.router.acp.message import MessageRouter, Route, _resolve_handler, _warn_legacy_handler
...
from bound.router.message.validator.model import model_to_kwargs, normalize_result
