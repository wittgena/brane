...
from bound.router.model.provider.manager import get_provider_info
from bound.router.model.types.utils import ModelInfo
...
def _build_model_info(
    ...
    from bound.router.model.cost.map import _get_model_info_helper
