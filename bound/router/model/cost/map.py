...
from bound.router.model.info.entry import get_model_info
from bound.router.model.provider.parser import get_model_cost_map
...
def _clear_model_info_caches() -> None:
    ...
    try:
        from bound.router.model.info.entry import _cached_get_model_info
