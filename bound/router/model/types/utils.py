# bound.router.model.types.utils
...
from bound.router.model.types.rerank import RerankResponse as RerankResponse
if TYPE_CHECKING:
    from bound.router.model.types.vector_stores import VectorStoreSearchResponse
else:
