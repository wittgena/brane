# bound.router.model.types.router
...
from bound.router.model.types.completion import CompletionRequest
from bound.router.model.types.embedding import EmbeddingRequest
from bound.router.model.types.llms.openai import OpenAIFileObject
from bound.router.model.types.search import SearchProvider
from bound.router.model.types.utils import CustomPricingLiteLLMParams, ModelResponse
