# bound.transport.session.connection
## @lineage: bound.router.conn.session.connection
## @lineage: xphi.server.session.connection
## @lineage: bound.conn.server.connection
## @lineage: bound.server.conn.connection
## @lineage: bound.adapter.mcps.stdio.connection
