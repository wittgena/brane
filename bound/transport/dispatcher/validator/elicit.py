# bound.transport.dispatcher.validator.elicit
## @lineage: bound.router.message.validator.elicit
## @lineage: xphi.server.elicitation
## @lineage: bound.server.elicitation
## @lineage: bound.adapter.mcps.stdio.elicitation
## @lineage: anchor.surface.mcps.stdio.elicitation
## @lineage: bound.server.mcps.elicitation
## @lineage: xphi.spec.mcps.server.elicitation
