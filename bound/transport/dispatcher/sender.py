# bound.transport.dispatcher.sender
## @lineage: bound.router.message.sender
## @lineage: bound.conn.sender
## @lineage: bound.broker.conn.sender
## @lineage: bound.adapter.broker.conn.sender
## @lineage: acps.broker.conn.sender
## @lineage: acps.message.sender
## @lineage: channel.acps.message.sender
## @lineage: bound.server.acps.message.sender
## @lineage: anchor.spec.acp.message.sender
## @lineage: xphi.spec.acp.message.sender
