# bound.bridge.api.response
## @lineage: anchor.action.api.response
import asyncio
import contextvars
...
from bound.channel.support.param.litellm import infer_openai_data_residency
...
def _responses_try_dispatch_emulated_file_search(
    *,
    ...
    from bound.channel.support.search.file import aresponses_with_emulated_file_search
