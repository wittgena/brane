# bound.bridge.transport.stream.chunk.builder
...
from anchor.surface.model.legacy.types.utils import TextChoices, TextCompletionResponse
...
from bound.bridge.transport.stream.chunk.processor import ChunkProcessor
