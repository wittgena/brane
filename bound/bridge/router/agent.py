# bound.bridge.router.agent
## @lineage: bound.broker.router.agent
...
from bound.bridge.router.message import MessageRouter, Route, _resolve_handler, _warn_legacy_handler
