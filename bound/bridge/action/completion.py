# bound.bridge.action.completion
## @lineage: bound.client.action.completion
## @lineage: anchor.router.action.completion
## @lineage: bound.router.action.completion
## @lineage: bound.channel.router.action.completion
import asyncio
import contextvars
import datetime
import inspect
...
from bound.bridge.action.handler.param.optional import get_optional_params
...
from bound.bridge.action.handler.completor import CompletionHandler
...
from bound.bridge.action.timeout import CompletionTimeout
...
from bound.bridge.action.handler.param.validator import (
