# bound.bridge.action.embedding
## @lineage: bound.client.action.embedding
## @lineage: anchor.router.action.embedding
## @lineage: bound.router.action.embedding
## @lineage: bound.channel.router.action.embedding
import asyncio
import contextvars
import datetime
import inspect
...
from anchor.model.llm.custom import CustomLLM
...
from bound.bridge.action.handler.param.embedding import get_optional_params_embeddings
