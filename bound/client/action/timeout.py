# bound.client.action.timeout
## @lineage: anchor.router.action.timeout
## @lineage: bound.router.action.timeout
## @lineage: bound.channel.router.action.timeout
## @lineage: channel.bridge.litellm.completion_timeout
from __future__ import annotations
from typing import Callable, Optional, Union
import httpx

from anchor.config.constants import COMPLETION_HTTP_FALLBACK_SECONDS, DEFAULT_REQUEST_TIMEOUT_SECONDS
