# bound.adapter.llama.readers.database.base
## @lineage: bound.channel.bridge.readers.database.base
## @lineage: channel.bridge.readers.database.base
## @lineage: bridge.llama.readers.database.base
## @lineage: channel.llama.readers.database.base
"""Database Reader."""
