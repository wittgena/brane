...
from bound.adapter.llama.callbacks import CBEventType, EventPayload
...
if TYPE_CHECKING:
    ...
    from bound.adapter.llama.llms.structured_llm import StructuredLLM
...
class LLM(BaseLLM):
    ...
    def structured_predict(
        ...
        **prompt_args: Any,
        ...
        """
        from bound.adapter.llama.program.utils import get_program_for_llm
