# bound.adapter.llama.llms.callbacks
## @lineage: bound.adapter.llms.callbacks
## @lineage: anchor.adapter.llms.callbacks
## @lineage: bridge.llama.core.llms.callbacks
import inspect
...
from bound.adapter.llama.callbacks import CallbackManager, CBEventType, EventPayload

# dispatcher setup
from bound.adapter.llama.instrumentation import get_dispatcher
from bound.adapter.llama.instrumentation.events.exception import ExceptionEvent
from bound.adapter.llama.instrumentation.span import active_span_id
from bound.adapter.llama.instrumentation.events.llm import (
