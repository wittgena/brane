# bound.adapter.llama.instrumentation.span_handlers.simple
...
from bound.adapter.llama.instrumentation.span.simple import SimpleSpan
from bound.adapter.llama.instrumentation.span_handlers.base import BaseSpanHandler
