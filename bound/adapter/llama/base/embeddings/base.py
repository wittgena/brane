# bound.adapter.llama.base.embeddings.base
## @lineage: xphi.adapter.llama.base.embeddings.base
...
from bound.adapter.llama.schema import BaseNode, MetadataMode, TransformComponent
from bound.adapter.llama.utils import get_tqdm_iterable
from bound.adapter.llama.async_utils import run_jobs
...
class BaseEmbedding(TransformComponent, DispatcherSpanMixin):
    ...
    def check_base_embeddings_class(self) -> Self:
        from bound.adapter.llama.storage.kvstore.types import BaseKVStore
