# bound.adapter.llama.base.llms.types
## @lineage: xphi.adapter.llama.base.llms.types
...
from bound.adapter.llama.schema import ImageDocument
from bound.adapter.llama.utils import get_tokenizer, resolve_binary
...
class BaseContentBlock(ABC, BaseModel):
    ...
    def get_template_vars(self) -> list[str]:
        ...
        """
        from bound.adapter.llama.prompts.utils import get_template_vars
    ...
    def format_vars(self, **kwargs: Any) -> "BaseContentBlock":
        ...
        For that to work, the validation on those fields would need to be updated though.
        """
        from bound.adapter.llama.prompts.utils import format_string
...
class TextBlock(BaseContentBlock):
    ...
    async def asplit(
        ...
        from bound.adapter.llama.node_parser import TokenTextSplitter
