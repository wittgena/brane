# bound.adapter.mcp.parser.header
## @lineage: xphi.adapter.mcp.parser.header
## @lineage: bound.adapter.mcp.legacy.header
## @lineage: bound.adapter.legacy.mcp.header
## @lineage: anchor.surface.legacy.mcp.header
import os
