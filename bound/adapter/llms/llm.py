# bound.adapter.llms.llm
## @lineage: anchor.adapter.llms.llm
...
from bound.adapter.async_utils import asyncio_run
...
from bound.adapter.callbacks import CBEventType, EventPayload
from bound.adapter.base.llms.base import BaseLLM
from bound.adapter.base.llms.generic_utils import (
    messages_to_prompt as generic_messages_to_prompt,
)
from bound.adapter.prompts import BasePromptTemplate, PromptTemplate
from bound.adapter.types import (
    BaseOutputParser,
    PydanticProgramMode,
    TokenAsyncGen,
    TokenGen,
...
from bound.adapter.instrumentation.events.llm import (
    LLMPredictEndEvent,
...
if TYPE_CHECKING:
    from bound.adapter.chat_engine.types import AgentChatResponse
    from bound.adapter.program.utils import FlexibleModel
    from bound.adapter.tools.types import BaseTool
    from bound.adapter.llms.structured_llm import StructuredLLM
...
class LLM(BaseLLM):
    ...
    def structured_predict(
        ...
        **prompt_args: Any,
        ...
        """
        from bound.adapter.program.utils import get_program_for_llm
    ...
    def predict_and_call(
        ...
        **kwargs: Any,
        ...
        """
        from bound.adapter.agent.workflow import ReActAgent
        from bound.adapter.agent.workflow.agent_context import SimpleAgentContext
        from bound.adapter.chat_engine.types import AgentChatResponse
        from bound.adapter.memory import Memory
        from bound.adapter.tools import adapt_to_async_tool
        from bound.adapter.tools.calling import call_tool_with_selection
    ...
    async def apredict_and_call(
        ...
        **kwargs: Any,
        ...
        from bound.adapter.memory import Memory
        from bound.adapter.tools import adapt_to_async_tool
        from bound.adapter.tools.calling import acall_tool_with_selection
