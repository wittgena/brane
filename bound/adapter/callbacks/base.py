...
from bound.adapter.callbacks.base_handler import BaseCallbackHandler
from bound.adapter.callbacks.schema import (
    BASE_TRACE_EVENT,
    LEAF_EVENTS,
    CBEventType,
    EventPayload,
...
from bound.adapter.bridge.pydantic_core import CoreSchema, core_schema
...
class CallbackManager(BaseCallbackHandler, ABC):
    ...
    def __init__(self, handlers: Optional[List[BaseCallbackHandler]] = None):
        ...
        if len(handlers) == 0:
            from bound.adapter.settings import Settings
