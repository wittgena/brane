# bound.adapter.legacy.llm.openai.completion
...
from bound.adapter.legacy.llm.base import BaseLLM
from bound.adapter.legacy.llm.openai.common_utils import (
    BaseOpenAILLM,
    OpenAIError,
    drop_params_from_unprocessable_entity_error,
)
from bound.adapter.legacy.llm.openai.config import OpenAIConfig
