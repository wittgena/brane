# bound.adapter.legacy.llm.types.router
...
from bound.adapter.legacy.llm.types.completion import CompletionRequest
from bound.adapter.legacy.llm.types.vector_stores import EmbeddingRequest
from bound.adapter.legacy.llm.openai.types import OpenAIFileObject
from bound.adapter.legacy.llm.types.utils import CustomPricingLiteLLMParams, ModelResponse, SearchProviders
