# bound.adapter.legacy.llm.types.utils
...
from bound.adapter.legacy.llm.base import BaseLiteLLMOpenAIResponseObject, LiteLLMPydanticObjectBase
from bound.channel.action.support.helpers import map_finish_reason
from bound.adapter.legacy.llm.base import HiddenParams
...
if TYPE_CHECKING:
    from bound.adapter.legacy.llm.types.vector_stores import VectorStoreSearchResponse
else:
