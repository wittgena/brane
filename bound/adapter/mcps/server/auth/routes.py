# bound.adapter.mcps.server.auth.routes
## @lineage: anchor.surface.mcps.server.auth.routes
## @lineage: bound.server.mcps.auth.routes
## @lineage: xphi.spec.mcps.server.auth.routes
## @lineage: xphi.spec.mcp.server.auth.routes
...
from bound.adapter.mcps.server.auth.handlers.authorize import AuthorizationHandler
from bound.adapter.mcps.server.auth.handlers.metadata import MetadataHandler, ProtectedResourceMetadataHandler
from bound.adapter.mcps.server.auth.handlers.register import RegistrationHandler
from bound.adapter.mcps.server.auth.handlers.revoke import RevocationHandler
from bound.adapter.mcps.server.auth.handlers.token import TokenHandler
from bound.adapter.mcps.server.auth.middleware.client_auth import ClientAuthenticator
from bound.adapter.mcps.server.auth.provider import OAuthAuthorizationServerProvider
from bound.adapter.mcps.server.auth.settings import ClientRegistrationOptions, RevocationOptions
from bound.adapter.mcps.stdio.streamable_http import MCP_PROTOCOL_VERSION_HEADER
