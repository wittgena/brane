# bound.adapter.instrumentation.span_handlers.simple
...
from bound.adapter.instrumentation.span.simple import SimpleSpan
from bound.adapter.instrumentation.span_handlers.base import BaseSpanHandler
