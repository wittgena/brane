# bound.adapter.litellm.support.metadata
## @lineage: bound.legacy.support.metadata
## @lineage: bound.client.support.metadata
...
## @lineage: channel.bound.litellm.response.metadata
## @lineage: gate.litellm.response.metadata
## @lineage: gate.litellm.llm_response_utils.response_metadata
...
from bound.adapter.litellm.support.helpers import process_response_headers
