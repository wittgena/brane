# bound.adapter.litellm.proxy.handler
...
from bound.adapter.litellm.proxy.reverse import global_mcp_server_manager, LegacyLitellmToolsManager
...
class MCPProxyHandler:
    ...
    def _create_tool_execution_events(
        ...
        for tool_result in tool_results:
            ...
            from bound.adapter.litellm.mcp.stream import create_mcp_call_events
    ...
    def _create_mcp_streaming_response(
        ...
        **kwargs,
        ...
        from bound.adapter.litellm.mcp.stream import MCPEnhancedStreamingIterator
