...
from bound.channel.compat.switch.params import ModelResponse, Choices, Message
...
def create_mock_tool_call(
    ...
    """
    import json
    from bound.channel.compat.switch.params import ChatCompletionMessageToolCall, Function
