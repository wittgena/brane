...
from anchor.channel.compat.switch.params import ModelResponse, Choices, Message
...
def create_mock_tool_call(
    ...
    """
    import json
    from anchor.channel.compat.switch.params import ChatCompletionMessageToolCall, Function
