...
from bound.server.proxy.reverse import global_mcp_server_manager, LegacyLitellmToolsManager
from bound.server.proxy.logger import LegacyLitellmLogManager
from anchor.spec.mcp.legacy.tool import transform_mcp_tool_to_openai_responses_api_tool, transform_mcp_tool_to_openai_tool
...
class MCPProxyHandler:
    ...
    def _create_tool_execution_events(
        ...
        for tool_result in tool_results:
            ...
            from anchor.spec.mcp.legacy.stream import create_mcp_call_events
    ...
    def _create_mcp_streaming_response(
        ...
        **kwargs,
        ...
        from anchor.spec.mcp.legacy.stream import MCPEnhancedStreamingIterator
