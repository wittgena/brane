# anchor.adapter.readers.file.base
...
from anchor.adapter.async_utils import get_asyncio_module, run_jobs
from anchor.adapter.readers.base import BaseReader, ResourcesReaderMixin
from anchor.adapter.schema import Document
from anchor.adapter.utils import get_tqdm_iterable
...
def _try_loading_included_file_formats() -> dict[
    ...
    try:
        from anchor.adapter.readers.file import (
            DocxReader,
            EpubReader,
            HWPReader,
            ImageReader,
