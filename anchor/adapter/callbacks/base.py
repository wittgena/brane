...
from anchor.adapter.callbacks.base_handler import BaseCallbackHandler
from anchor.adapter.callbacks.schema import (
    BASE_TRACE_EVENT,
    LEAF_EVENTS,
    CBEventType,
    EventPayload,
...
from anchor.adapter.bridge.pydantic_core import CoreSchema, core_schema
...
class CallbackManager(BaseCallbackHandler, ABC):
    ...
    def __init__(self, handlers: Optional[List[BaseCallbackHandler]] = None):
        ...
        if len(handlers) == 0:
            from anchor.adapter.settings import Settings
