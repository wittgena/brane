# anchor.adapter.base.llms.types
## @lineage: bound.adapter.base.llms.types
## @lineage: bridge.llama.core.base.llms.types
...
from anchor.adapter.constants import DEFAULT_CONTEXT_WINDOW, DEFAULT_NUM_OUTPUTS
from anchor.adapter.schema import ImageDocument
from anchor.adapter.utils import get_tokenizer, resolve_binary
...
class BaseContentBlock(ABC, BaseModel):
    ...
    def get_template_vars(self) -> list[str]:
        ...
        """
        from anchor.adapter.prompts.utils import get_template_vars
    ...
    def format_vars(self, **kwargs: Any) -> "BaseContentBlock":
        ...
        For that to work, the validation on those fields would need to be updated though.
        """
        from anchor.adapter.prompts.utils import format_string
...
class TextBlock(BaseContentBlock):
    ...
    async def asplit(
        ...
        from anchor.adapter.node_parser import TokenTextSplitter
