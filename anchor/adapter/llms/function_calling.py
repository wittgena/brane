# anchor.adapter.llms.function_calling
## @lineage: bound.adapter.llms.function_calling
## @lineage: bridge.llama.core.llms.function_calling
import asyncio
...
class FunctionCallingLLM(LLM):
    ...
    def predict_and_call(
        ...
        **kwargs: Any,
        ...
        """Predict and call the tool."""
        from anchor.adapter.chat_engine.types import AgentChatResponse
        from anchor.adapter.tools.calling import (
