# anchor.adapter.llms.llm
## @lineage: bound.adapter.llms.llm
## @lineage: bridge.llama.core.llms.llm
...
from anchor.adapter.async_utils import asyncio_run
...
from anchor.adapter.callbacks import CBEventType, EventPayload
from anchor.adapter.base.llms.base import BaseLLM
from anchor.adapter.base.llms.generic_utils import (
    messages_to_prompt as generic_messages_to_prompt,
)
from anchor.adapter.prompts import BasePromptTemplate, PromptTemplate
from anchor.adapter.types import (
    BaseOutputParser,
    PydanticProgramMode,
    TokenAsyncGen,
    TokenGen,
...
from anchor.adapter.instrumentation.events.llm import (
    LLMPredictEndEvent,
...
if TYPE_CHECKING:
    from anchor.adapter.chat_engine.types import AgentChatResponse
    from anchor.adapter.program.utils import FlexibleModel
    from anchor.adapter.tools.types import BaseTool
    from anchor.adapter.llms.structured_llm import StructuredLLM
...
class LLM(BaseLLM):
    ...
    def structured_predict(
        ...
        **prompt_args: Any,
        ...
        """
        from anchor.adapter.program.utils import get_program_for_llm
    ...
    def predict_and_call(
        ...
        **kwargs: Any,
        ...
        """
        from anchor.adapter.agent.workflow import ReActAgent
        from anchor.adapter.agent.workflow.agent_context import SimpleAgentContext
        from anchor.adapter.chat_engine.types import AgentChatResponse
        from anchor.adapter.memory import Memory
        from anchor.adapter.tools import adapt_to_async_tool
        from anchor.adapter.tools.calling import call_tool_with_selection
    ...
    async def apredict_and_call(
        ...
        **kwargs: Any,
        ...
        from anchor.adapter.memory import Memory
        from anchor.adapter.tools import adapt_to_async_tool
        from anchor.adapter.tools.calling import acall_tool_with_selection
