# anchor.model.info.features
## @lineage: anchor.router.model.info.features
## @lineage: bound.router.model.info.features
## @lineage: bound.channel.model.info.features
## @lineage: channel.model.info.features
