...
from anchor.surface.provider.config.factory import get_provider_info
from anchor.surface.model.client.types import ModelInfo
...
def _build_model_info(
    ...
    from anchor.surface.provider.registry import _get_model_info_helper
