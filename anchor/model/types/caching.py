# anchor.model.types.caching
## @lineage: anchor.router.model.types.caching
## @lineage: bound.router.model.types.caching
## @lineage: bound.channel.model.types.caching
## @lineage: channel.model.types.caching
## @lineage: gate.model.types.caching
## @lineage: gate.types.caching
## @lineage: blm.types.caching
