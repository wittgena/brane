# anchor.model.provider.parser
## @lineage: anchor.router.model.provider.parser
## @lineage: bound.router.model.provider.parser
## @lineage: bound.channel.model.provider.parser
## @lineage: channel.model.provider.parser
## @lineage: channel.provider.parser
## @lineage: gate.model.provider.parser
## @lineage: gate.llms.provider.parser
import json
import os
...
log = get_emitter("provider.parser")

IO_ROOT = Path(resolve_path("io"))
BACKUP_DIR = IO_ROOT / "llms" / "registry_backups"
