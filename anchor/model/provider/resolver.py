...
from gate.constants import REPLICATE_MODEL_NAME_WITH_ID_LENGTH
from anchor.model.types.router import LiteLLM_Params
from gate.io.secret.manager import get_secret_str, get_secret 
...
class LLMProviderResolver:
    ...
    def _resolve_special_cases(self, model: str, custom_llm_provider: Optional[str]) -> Tuple[str, Optional[str], bool]:
        from channel.gov.cost.model import get_provider_for_model
