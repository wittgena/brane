# anchor.router.model.types.search
## @lineage: bound.router.model.types.search
## @lineage: bound.channel.model.types.search
## @lineage: channel.model.types.search
## @lineage: anchor.model.types.search
## @lineage: gate.model.types.search
## @lineage: gate.types.search
## @lineage: blm.types.search
from typing import List, Optional
from typing_extensions import Required, TypedDict
from anchor.router.model.types.utils import SearchProviders
