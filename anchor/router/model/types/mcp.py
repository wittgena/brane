# anchor.router.model.types.mcp
## @lineage: bound.router.model.types.mcp
## @lineage: bound.channel.model.types.mcp
## @lineage: channel.model.types.mcp
## @lineage: anchor.model.types.mcp
## @lineage: gate.model.types.mcp
## @lineage: gate.types.mcp
## @lineage: blm.types.mcp
import enum
