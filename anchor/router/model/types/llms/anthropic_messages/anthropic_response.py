# anchor.router.model.types.llms.anthropic_messages.anthropic_response
## @lineage: bound.router.model.types.llms.anthropic_messages.anthropic_response
## @lineage: bound.channel.model.types.llms.anthropic_messages.anthropic_response
## @lineage: channel.model.types.llms.anthropic_messages.anthropic_response
## @lineage: anchor.model.types.llms.anthropic_messages.anthropic_response
## @lineage: gate.model.types.llms.anthropic_messages.anthropic_response
## @lineage: gate.types.llms.anthropic_messages.anthropic_response
## @lineage: blm.types.llms.anthropic_messages.anthropic_response
