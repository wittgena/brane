# anchor.router.model.types.llms.vertex_ai
## @lineage: bound.router.model.types.llms.vertex_ai
## @lineage: bound.channel.model.types.llms.vertex_ai
## @lineage: channel.model.types.llms.vertex_ai
## @lineage: anchor.model.types.llms.vertex_ai
## @lineage: gate.model.types.llms.vertex_ai
## @lineage: gate.types.llms.vertex_ai
## @lineage: blm.types.llms.vertex_ai
...
from anchor.router.model.types.llms.openai import EmbeddingInput
