# anchor.router.model.info.entry
...
from anchor.router.model.provider.manager import get_provider_info
from anchor.router.model.types.utils import ModelInfo
...
def _build_model_info(
    ...
    from anchor.router.model.cost.map import _get_model_info_helper
