# anchor.router.search.file
## @lineage: meta.flow.search.file
## @lineage: channel.search.file
import json
import time
from typing import Any, Dict, Iterable, List, Optional, Tuple, Union, cast

from bound.handler.response.main import aresponses
from channel.model.types.llms.openai import ResponseOutputItem, ResponsesAPIResponse
from channel.model.types.vector_stores import VectorStoreSearchResult
