# anchor.action.backup.acompletion
## @lineage: anchor.surface.legacy.action.backup.acompletion
...
from anchor.action.completion import completion
...
from anchor.surface.legacy.llm.openai.types import ChatCompletionAudioParam, ChatCompletionModality, ChatCompletionPredictionContentParam, OpenAIWebSearchOptions
