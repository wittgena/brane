...
from anchor.xor.chat import ChatAdapter, FieldInfoWithName
from anchor.xor.utils import format_field_value, translate_field_type
...
class XMLAdapter(ChatAdapter):
    ...
    def parse(self, signature: type[Signature], completion: str) -> dict[str, Any]:
        ...
        if fields.keys() != signature.output_fields.keys():
            from channel.bridge.dsp.exceptions import AdapterParseError
    ...
    def _parse_field_value(self, field_info, raw, completion, signature):
        from anchor.xor.utils import parse_value
