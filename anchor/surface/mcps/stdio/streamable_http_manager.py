# anchor.surface.mcps.stdio.streamable_http_manager
...
from anchor.surface.mcps.server.auth.middleware.bearer_auth import AuthenticatedUser, AuthorizationContext, authorization_context
from anchor.surface.mcps.stdio.streamable_http import (
