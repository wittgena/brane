# anchor.surface.mcps.server.auth.settings
## @lineage: xphi.server.auth.settings
## @lineage: bound.server.auth.settings
...
## @lineage: xphi.spec.mcps.server.auth.settings
## @lineage: xphi.spec.mcp.server.auth.settings
