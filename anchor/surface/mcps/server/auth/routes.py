# anchor.surface.mcps.server.auth.routes
...
from anchor.surface.mcps.server.auth.handlers.authorize import AuthorizationHandler
from anchor.surface.mcps.server.auth.handlers.metadata import MetadataHandler, ProtectedResourceMetadataHandler
from anchor.surface.mcps.server.auth.handlers.register import RegistrationHandler
from anchor.surface.mcps.server.auth.handlers.revoke import RevocationHandler
from anchor.surface.mcps.server.auth.handlers.token import TokenHandler
from anchor.surface.mcps.server.auth.middleware.client_auth import ClientAuthenticator
from anchor.surface.mcps.server.auth.provider import OAuthAuthorizationServerProvider
from anchor.surface.mcps.server.auth.settings import ClientRegistrationOptions, RevocationOptions
from anchor.surface.mcps.stdio.streamable_http import MCP_PROTOCOL_VERSION_HEADER
