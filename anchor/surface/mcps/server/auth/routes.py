...
## @lineage: xphi.server.auth.routes
...
from anchor.surface.mcps.server.handler.register import RegistrationHandler
from anchor.surface.mcps.server.handler.revoke import RevocationHandler
from anchor.surface.mcps.server.handler.token import TokenHandler
from anchor.surface.mcps.server.middleware.client_auth import ClientAuthenticator
