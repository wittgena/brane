# anchor.surface.mcps.server.pagination.server
## @lineage: bound.server.mcps.pagination.server
## @lineage: xphi.spec.mcps.server.pagination.server
...
from anchor.surface.mcps.stdio.context import ServerRequestContext
...
def main(port: int, transport: str) -> int:
    ...
    if transport == "streamable-http":
        ...
        from anchor.surface.mcps.stdio.server import stdio_server
