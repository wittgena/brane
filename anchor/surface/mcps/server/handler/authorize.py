# anchor.surface.mcps.server.handler.authorize
## @lineage: xphi.server.auth.handlers.authorize
## @lineage: bound.server.auth.handlers.authorize
...
## @lineage: xphi.spec.mcps.server.auth.handlers.authorize
