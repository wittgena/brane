...
class BooleanPropertySchema(BaseModel):
    # Default value.
    default: Annotated[bool | None, Field(description='Default value.')] = None
    ...
    title: Annotated[
        str | None, Field(description='Optional title for the property.')
    ] = None
...
class Cost(BaseModel):
    ...
    currency: Annotated[
        str, Field(description='ISO 4217 currency code (e.g., "USD", "EUR").')
    ]
...
class Diff(BaseModel):
    ...
    old_text: Annotated[
        str | None,
        Field(
            alias='oldText', description='The original content (None for new files).'
        ),
    ] = None
...
class ElicitationContentValue(RootModel[str | int | float | bool | list[str]]):
    root: str | int | float | bool | list[str]
...
class ElicitationStringType(StrEnum):
    string = 'string'
...
class IntegerPropertySchema(BaseModel):
    # Default value.
    default: Annotated[int | None, Field(description='Default value.')] = None
    # Human-readable description.
    description: Annotated[
        str | None, Field(description='Human-readable description.')
    ] = None
    # Maximum value (inclusive).
    maximum: Annotated[int | None, Field(description='Maximum value (inclusive).')] = (
        None
    )
    # Minimum value (inclusive).
    minimum: Annotated[int | None, Field(description='Minimum value (inclusive).')] = (
        None
    )
    # Optional title for the property.
    title: Annotated[
...
class NesDiagnosticSeverity(StrEnum):
    error = 'error'
    warning = 'warning'
...
class NesRelatedSnippet(BaseModel):
    ...
    uri: Annotated[
        str, Field(description='The URI of the file containing the snippets.')
    ]
...
class NesSearchAndReplaceSuggestion(BaseModel):
    ...
    id: Annotated[
        str, Field(description='Unique identifier for accept/reject tracking.')
    ]
...
class NumberPropertySchema(BaseModel):
    # Default value.
    default: Annotated[float | None, Field(description='Default value.')] = None
    # Human-readable description.
    description: Annotated[
        str | None, Field(description='Human-readable description.')
    ] = None
    # Maximum value (inclusive).
    maximum: Annotated[
        float | None, Field(description='Maximum value (inclusive).')
    ] = None
    # Minimum value (inclusive).
    minimum: Annotated[
        float | None, Field(description='Minimum value (inclusive).')
    ] = None
    # Optional title for the property.
    title: Annotated[
        str | None, Field(description='Optional title for the property.')
...
class ProviderInfo(BaseModel):
    ...
    id: Annotated[
        str, Field(description='Provider identifier, for example "main" or "openai".')
    ]
...
class SessionInfo(BaseModel):
    ...
    session_id: Annotated[
        str, Field(alias='sessionId', description='Unique identifier for the session')
    ]
...
class StringPropertySchema(BaseModel):
    # Default value.
    default: Annotated[str | None, Field(description='Default value.')] = None
    # Human-readable description.
    description: Annotated[
        str | None, Field(description='Human-readable description.')
    ] = None
    ...
    # String format.
    format: Annotated[StringFormat | None, Field(description='String format.')] = None
    # Maximum string length.
    max_length: Annotated[
        int | None, Field(alias='maxLength', description='Maximum string length.', ge=0)
    ] = None
    # Minimum string length.
    min_length: Annotated[
        int | None, Field(alias='minLength', description='Minimum string length.', ge=0)
    ] = None
    ...
    pattern: Annotated[
        str | None, Field(description='Pattern the string must match.')
    ] = None
    # Optional title for the property.
    title: Annotated[
        str | None, Field(description='Optional title for the property.')
...
class TextDocumentSyncKind(StrEnum):
    full = 'full'
...
class TitledMultiSelectItems(BaseModel):
    # Titled enum options.
    any_of: Annotated[
        list[EnumOption], Field(alias='anyOf', description='Titled enum options.')
    ]
...
class UntitledMultiSelectItems(BaseModel):
    ...
    type: Annotated[
        ...
        Field(description='Item type discriminator. Must be `"string"`.'),
    ]
...
class CloseNesRequest(BaseModel):
    ...
    session_id: Annotated[
        str, Field(alias='sessionId', description='The ID of the NES session to close.')
    ]
...
class CloseSessionRequest(BaseModel):
    ...
    session_id: Annotated[
        str, Field(alias='sessionId', description='The ID of the session to close.')
    ]
...
class _CurrentModeUpdate(BaseModel):
    ...
    current_mode_id: Annotated[
        str, Field(alias='currentModeId', description='The ID of the current mode')
    ]
...
class DeleteSessionRequest(BaseModel):
    ...
    session_id: Annotated[
        str, Field(alias='sessionId', description='The ID of the session to delete.')
    ]
...
class ElicitationUrlMode(RootModel[ElicitationUrlSessionMode | ElicitationUrlRequestMode]):
    # **UNSTABLE**
    #
    # This capability is not part of the spec yet, and may be removed or changed at any point.
    #
...
class MultiSelectPropertySchema(BaseModel):
    ...
    default: Annotated[
        list[str] | None, Field(description='Default selected values.')
    ] = None
    # Human-readable description.
    description: Annotated[
        str | None, Field(description='Human-readable description.')
...
class NesDiagnostic(BaseModel):
    ...
    uri: Annotated[
        str, Field(description='The URI of the file containing the diagnostic.')
    ]
...
class NesUserAction(BaseModel):
    ...
    uri: Annotated[
        str, Field(description='The URI of the file where the action occurred.')
    ]
...
class SessionConfigOptionBoolean(SessionConfigBoolean):
    ...
    category: Annotated[
        Literal['mode'] | Literal['model'] | Literal['thought_level'] | str | None,
    ...
    id: Annotated[
        str, Field(description='Unique identifier for the configuration option.')
    ]
...
class ClientResponse(RootModel[ClientResponseMessage | ClientErrorMessage]):
    root: ClientResponseMessage | ClientErrorMessage
...
class ElicitationSchema(BaseModel):
    ...
    required: Annotated[
        list[str] | None, Field(description='List of required property names.')
    ] = None
    # Optional title for the schema.
    title: Annotated[
        str | None, Field(description='Optional title for the schema.')
    ] = None
...
class NewSessionRequest(BaseModel):
    ...
    mcp_servers: Annotated[
        list[HttpMcpServer | SseMcpServer | AcpMcpServer | McpServerStdio],
        Field(
            alias='mcpServers',
...
class ResumeSessionRequest(BaseModel):
    ...
    mcp_servers: Annotated[
        list[HttpMcpServer | SseMcpServer | AcpMcpServer | McpServerStdio] | None,
        Field(
            alias='mcpServers',
    ...
    session_id: Annotated[
        str, Field(alias='sessionId', description='The ID of the session to resume.')
    ]
...
class ElicitationFormMode(RootModel[ElicitationFormSessionMode | ElicitationFormRequestMode]):
    # **UNSTABLE**
    #
    # This capability is not part of the spec yet, and may be removed or changed at any point.
    #
...
class ForkSessionRequest(BaseModel):
    ...
    session_id: Annotated[
        str, Field(alias='sessionId', description='The ID of the session to fork.')
    ]
...
class InitializeResponse(BaseModel):
    ...
    auth_methods: Annotated[
        list[EnvVarAuthMethod | TerminalAuthMethod | AuthMethodAgent] | None,
        Field(
            alias='authMethods',
...
class SessionConfigSelect(BaseModel):
    ...
    current_value: Annotated[
        str, Field(alias='currentValue', description='The currently selected value.')
    ]
...
class SetSessionConfigOptionResponse(BaseModel):
    ...
    config_options: Annotated[
        list[
            Annotated[
                SessionConfigOptionSelect | SessionConfigOptionBoolean, Field(discriminator='type')
            ]
        ],
        Field(
            alias='configOptions',
...
class ToolCallUpdate(BaseModel):
    ...
    kind: Annotated[ToolKind | None, Field(description='Update the tool kind.')] = None
    ...
    status: Annotated[
        ToolCallStatus | None, Field(description='Update the execution status.')
    ] = None
...
class AgentResponse(RootModel[AgentResponseMessage | AgentErrorMessage]):
    root: AgentResponseMessage | AgentErrorMessage
