# anchor.surface.legacy.openai.completion
...
from anchor.surface.legacy.openai.common_utils import (
    BaseOpenAILLM,
    OpenAIError,
    drop_params_from_unprocessable_entity_error,
)
from anchor.surface.legacy.openai.openai import OpenAIConfig
