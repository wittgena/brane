# anchor.surface.legacy.llm.types.utils
...
from anchor.surface.legacy.llm.base import BaseLiteLLMOpenAIResponseObject, LiteLLMPydanticObjectBase
from bound.channel.support.helpers import map_finish_reason
from anchor.surface.legacy.llm.base import HiddenParams
...
if TYPE_CHECKING:
    from anchor.surface.legacy.llm.types.vector_stores import VectorStoreSearchResponse
else:
