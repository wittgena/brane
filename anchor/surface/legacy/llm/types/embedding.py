# anchor.surface.legacy.llm.types.embedding
## @lineage: anchor.surface.legacy.types.embedding
...
## @lineage: channel.model.types.embedding
## @lineage: gate.model.types.embedding
## @lineage: gate.types.embedding
## @lineage: blm.types.embedding
