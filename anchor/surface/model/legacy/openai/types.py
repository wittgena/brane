# anchor.surface.model.legacy.openai.types
## @lineage: bound.adapter.legacy.llm.openai.types
## @lineage: anchor.surface.legacy.llm.openai.types
## @lineage: anchor.model.llm.types.openai
