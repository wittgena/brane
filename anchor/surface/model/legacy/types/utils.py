# anchor.surface.model.legacy.types.utils
## @lineage: bound.adapter.legacy.llm.types.utils
## @lineage: anchor.surface.legacy.llm.types.utils
## @lineage: anchor.surface.legacy.types.utils
...
from anchor.surface.model.legacy.base import BaseLiteLLMOpenAIResponseObject, LiteLLMPydanticObjectBase
from anchor.channel.action.support.helpers import map_finish_reason
from anchor.surface.model.legacy.base import HiddenParams
...
if TYPE_CHECKING:
    from anchor.surface.model.legacy.types.vector_stores import VectorStoreSearchResponse
else:
