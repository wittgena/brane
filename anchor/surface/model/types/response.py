# anchor.surface.model.types.response
## @lineage: anchor.surface.model.legacy.types.response
## @lineage: bound.adapter.legacy.llm.types.response
## @lineage: anchor.surface.legacy.llm.types.response
## @lineage: anchor.surface.legacy.types.response
