# anchor.surface.model.types.utils
...
from anchor.surface.model.types.base import BaseOpenAIResponse, PydanticObjectBase
from anchor.channel.action.support.helpers import map_finish_reason
from anchor.surface.model.types.base import HiddenParams
...
from anchor.surface.model.types.support import ProviderSpecificModelInfo

if TYPE_CHECKING:
    from anchor.surface.model.types.vector_stores import VectorStoreSearchResponse
else:
...
class ImageUsageInputTokensDetails(BaseOpenAIResponse):
    image_tokens: int
...
class ImageUsage(BaseOpenAIResponse):
    input_tokens: int
...
class ImageResponse(OpenAIImageResponse, BaseOpenAIResponse):
    _hidden_params: dict = {}
...
class LiteLLMRealtimeStreamLoggingObject(PydanticObjectBase):
