# anchor.surface.model.client.openai.completion
## @lineage: anchor.surface.model.openai.completion
## @lineage: anchor.surface.model.types.openai.completion
## @lineage: anchor.surface.model.legacy.openai.completion
## @lineage: bound.adapter.legacy.llm.openai.completion
## @lineage: anchor.surface.legacy.llm.openai.completion
## @lineage: anchor.surface.legacy.openai.completion
## @lineage: bound.inter.llms.openai.completion
import time
...
from anchor.surface.model.client.base import BaseLLM
from anchor.surface.model.client.openai.base import (
    BaseOpenAILLM,
    OpenAIError,
    drop_params_from_unprocessable_entity_error,
)
from anchor.surface.model.client.openai.config import OpenAIConfig
