# anchor.surface.model.token.encoding
## @lineage: anchor.model.token.encoding
## @lineage: anchor.router.model.token.encoding
## @lineage: bound.router.model.token.encoding
## @lineage: bound.channel.model.token.encoding
## @lineage: channel.model.token.encoding
## @lineage: bound.token.encoding
