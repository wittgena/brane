...
## @lineage: bound.inter.embeddings.huggingface.pooling
## @lineage: bound.adapter.llama.embeddings.huggingface.pooling
## @lineage: bound.channel.bridge.embeddings.huggingface.pooling
## @lineage: channel.bridge.embeddings.huggingface.pooling
## @lineage: bridge.llama.embeddings.huggingface.pooling
