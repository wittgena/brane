# anchor.inter.embeddings.huggingface.base
## @lineage: bound.inter.embeddings.huggingface.base
import asyncio
...
from xphi.adapter.llama.utils import get_cache_dir, infer_torch_device
