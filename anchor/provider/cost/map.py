# anchor.provider.cost.map
## @lineage: anchor.surface.model.cost.map
## @lineage: anchor.model.info.cost.map
import os
import litellm
...
def _clear_model_info_caches() -> None:
    ...
    try:
        from anchor.channel.compat.switch.model.info import _cached_get_model_info
