# anchor.channel.action.api.response
...
class ResponsesDispatcher:
    ...
    def _dispatch_mcp(self) -> Optional[Any]:
        ...
        if self.ctx.is_async:
            from anchor.channel.action.api.aresponse import aresponses_api_with_mcp
    ...
    def _dispatch_file_search(self) -> Optional[Any]:
        from anchor.channel.action.support.search.file import aresponses_with_emulated_file_search
