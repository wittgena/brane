# anchor.channel.bridge.completor
## @lineage: anchor.channel.client.completor
## @lineage: bound.channel.client.completor
"""
...
from anchor.channel.bridge.client import Client
