# anchor.channel.compat.switch.model.openai
## @lineage: anchor.channel.switch.model.openai
## @lineage: anchor.switch.model.openai
## @lineage: anchor.model.info.openai_params
