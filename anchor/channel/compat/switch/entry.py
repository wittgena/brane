# anchor.channel.compat.switch.entry
...
"""
import os
from anchor.channel.compat.switch.params import LITELLM_CONVERT_SWITCH
...
if not LITELLM_CONVERT_SWITCH:
    try:
        from anchor.channel.client.action.completion import completion, acompletion
        from anchor.channel.client.action.embedding import embedding, aembedding
