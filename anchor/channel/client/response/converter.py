# anchor.channel.client.response.converter
...
from anchor.channel.client.action.support.header import get_response_headers
from anchor.surface.model.openai.types import (
    ChatCompletionThinkingBlock,
    ImageURLListItem,
    OpenAIModerationResponse,
)
from anchor.channel.compat.switch.params import (
...
from anchor.surface.model.types import Logprobs as TextCompletionLogprobs
