# anchor.channel.client.action.param.embedding
...
from anchor.channel.client.action.param.optional import PreProcessNonDefaultParams, add_provider_specific_params_to_optional_params
