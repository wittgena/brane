# anchor.channel.client.action.support.helpers
## @lineage: anchor.channel.action.support.helpers
## @lineage: bound.channel.action.support.helpers
## @lineage: bound.channel.support.helpers
## @lineage: bound.adapter.litellm.support.helpers
## @lineage: bound.legacy.support.helpers
## @lineage: bound.client.support.helpers
...
from anchor.surface.model.openai.types import AllMessageValues, OpenAIChatCompletionFinishReason
if TYPE_CHECKING:
    from opentelemetry.trace import Span as _Span
    from anchor.channel.compat.switch.params import ModelResponseStream
...
def process_response_headers(response_headers: Union[httpx.Headers, dict]) -> dict:
    from anchor.surface.model.types import OPENAI_RESPONSE_HEADERS
