# anchor.channel.client.action.preprocessor
...
from anchor.channel.client.action.param.litellm import get_litellm_params
from anchor.channel.client.action.param.validator import (
...
class EmbeddingPreprocessor:
    ...
    def build(self) -> EmbeddingContext:
        ...
        from anchor.channel.client.action.param.embedding import get_optional_params_embeddings
