# anchor.channel.switch.model.token.counter
## @lineage: anchor.switch.model.token.counter
...
from anchor.channel.switch.params import Message
...
def _get_count_function(
    ...
    from anchor.channel.switch.model.token.tokenizer import _select_tokenizer
