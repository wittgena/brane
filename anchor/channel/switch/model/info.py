# anchor.channel.switch.model.info
...
from anchor.channel.action.param.format import BaseLLMModelInfo, type_to_response_format_param
...
def _build_model_info(
    ...
    from anchor.surface.model.cost.map import _get_model_info_helper
