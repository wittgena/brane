# anchor.switch.model.llm.provider
...
from xor.secret.manager import get_secret_str, get_secret 
...
class LLMProviderResolver:
    ...
    def _resolve_by_model_name(self, model: str, custom_llm_provider: Optional[str]) -> Tuple[str, Optional[str]]:
        from anchor.surface.model.cost.model import get_provider_for_model
