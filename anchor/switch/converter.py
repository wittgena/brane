# anchor.switch.converter
## @lineage: anchor.router.switch.converter
import os
import sys
import argparse
import threading
...
log = get_emitter("switch.converter", phase="SYSTEM")
...
def main(args=None):
    ...
    if bound_args.local:
        ...
        dispatch_cli("switch.converter", entry_task, __file__)
