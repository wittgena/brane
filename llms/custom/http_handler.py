# channel.llms.custom.http_handler
...
if TYPE_CHECKING:
    ...
    from llms.custom.aiohttp_transport import LiteLLMAiohttpTransport
else:
    LlmProviders = Any
...
class AsyncHTTPHandler:
    ...
    def _create_aiohttp_transport(
        ...
        from channel.bound.custom_httpx.aiohttp_transport import LiteLLMAiohttpTransport
