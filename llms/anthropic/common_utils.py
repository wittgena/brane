# channel.llms.anthropic.common_utils
## @lineage: gate.llms.anthropic.common_utils
import copy
from typing import Any, Dict, List, Optional, Union
import httpx
from llms.base.utils import BaseLLMModelInfo, BaseTokenCounter
...
from llms.custom.http_handler import HTTPHandler
...
class AnthropicModelInfo(BaseLLMModelInfo):
    ...
    def _supports_model_capability(model: str, key: str) -> bool:
        from channel.bound.gate import _supports_factory
        try:
