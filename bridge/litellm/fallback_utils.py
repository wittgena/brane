# bridge.litellm.fallback_utils
## @lineage: channel.litellm.fallback_utils
## @lineage: channel.bound.litellm.fallback_utils
## @lineage: gate.litellm.fallback_utils
## @lineage: gate.bound.core.fallback_utils
...
import litellm
from bridge.litellm.core_helpers import safe_deep_copy, filter_internal_params
from bridge.litellm.asyncify import run_async_function
from watcher.plane.emitter import get_emitter

log = get_emitter("fallback.utils")
