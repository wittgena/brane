# channel.llama.core.readers.base
"""Base reader class."""
import asyncio
...
from channel.llama.core.bridge.pydantic import ConfigDict, Field
from channel.llama.core.schema import BaseComponent, Document
