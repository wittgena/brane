# channel.llama.readers.web.zenrows_web.base
"""ZenRows Web Reader."""
...
import requests
from channel.llama.core.bridge.pydantic import Field, PrivateAttr, field_validator
from channel.llama.core.readers.base import BasePydanticReader
