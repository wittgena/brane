# channel.llama.readers.file.image_vision_llm.base
from pathlib import Path
from typing import Dict, List, Optional

from channel.llama.core.readers.base import BaseReader
from channel.llama.core.schema import Document, ImageDocument
from channel.llama.core.utils import infer_torch_device
...
class ImageVisionLLMReader(BaseReader):
    ...
    def load_data(
        ...
        """Parse file."""
        from channel.llama.core.img_utils import img_2_b64
