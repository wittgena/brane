...
from gate.model.types.llms.openai import AllMessageValues, OpenAIChatCompletionFinishReason
if TYPE_CHECKING:
    from opentelemetry.trace import Span as _Span
    from channel.switch.params import ModelResponseStream
...
def process_response_headers(response_headers: Union[httpx.Headers, dict]) -> dict:
    from gate.model.types.utils import OPENAI_RESPONSE_HEADERS
