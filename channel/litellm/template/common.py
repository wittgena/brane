# channel.litellm.template.common
## @lineage: gate.litellm.template.common
import io
import json
import mimetypes
import re
...
from gate.model.types.llms.openai import ChatCompletionImageObject, ChatCompletionImageUrlObject
...
from gate.model.types.utils import ExtractedFileData, FileTypes, SpecialEnums
from gate.model.types.llms.openai import (
    AllMessageValues,
    ChatCompletionAssistantMessage,
    ChatCompletionFileObject,
...
from gate.model.types.llms.openai import ChatCompletionImageObject
...
if TYPE_CHECKING:
    from channel.bound.plane import Logging as LoggingClass
