# channel.bound.handler.stream.wrapper
...
class CustomStreamWrapper:
    ...
    def _check_max_streaming_duration(self) -> None:
        ...
        from gate.constants import LITELLM_MAX_STREAMING_DURATION_SECONDS
    ...
    def _handle_stream_fallback_error(self, e: Exception) -> "NoReturn":
        ...
        """
        from gate.exceptions import MidStreamFallbackError
