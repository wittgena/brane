...
def token_counter(
    ...
    from channel.bound.token.convert import convert_list_message_to_dict
...
def _get_count_function(
    ...
    from channel.bound.token.tokenizer import _select_tokenizer
