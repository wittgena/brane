# channel.cost.tool_call_cost_tracking
...
from gate.constants import OPENAI_FILE_SEARCH_COST_PER_1K_CALLS
from gate.model.types.llms.openai import FileSearchTool, ResponsesAPIResponse, WebSearchOptions
from gate.model.types.utils import ModelInfo, SearchContextCostPerQuery, StandardBuiltInToolsParams, PromptTokensDetailsWrapper
...
class StandardBuiltInToolCostTracking:
    ...
    def get_cost_for_file_search(
        ...
        if provider == "azure":
            from gate.constants import AZURE_FILE_SEARCH_COST_PER_GB_PER_DAY
    ...
    def get_cost_for_vector_store(
        ...
        if provider == "azure":
            from gate.constants import AZURE_VECTOR_STORE_COST_PER_GB_PER_DAY
