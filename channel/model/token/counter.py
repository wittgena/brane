...
from channel.model.token.encoding import get_default_encoding
...
def token_counter(
    ...
    from channel.model.token.convert import convert_list_message_to_dict
...
def _get_count_function(
    ...
    from channel.model.token.tokenizer import _select_tokenizer
