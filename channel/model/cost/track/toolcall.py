# channel.model.cost.track.toolcall
...
from channel.model.types.llms.openai import FileSearchTool, ResponsesAPIResponse, WebSearchOptions
from channel.model.types.utils import ModelInfo, SearchContextCostPerQuery, StandardBuiltInToolsParams, PromptTokensDetailsWrapper
...
class StandardBuiltInToolCostTracking:
    ...
    def get_cost_for_file_search(
        ...
        if provider == "azure":
            from bound.config.constants import AZURE_FILE_SEARCH_COST_PER_GB_PER_DAY
    ...
    def get_cost_for_vector_store(
        ...
        if provider == "azure":
            from bound.config.constants import AZURE_VECTOR_STORE_COST_PER_GB_PER_DAY
