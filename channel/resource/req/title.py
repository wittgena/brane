# channel.resource.req.title
## @lineage: gov.gateway.io.resource.req.title
## @lineage: gov.medium.io.resource.req.title
## @lineage: gov.io.resource.req.title
## @lineage: bound.io.resource.req.title
from collections.abc import Sequence
from gov.gateway.io.event.llm.message import MessageEvent
from gov.gateway.io.event.base import Event
from channel.llm.driver import Driver
from agent.call.tool.message import Message, TextContent
                ...
                content=[
                    TextContent(
                        text=(
                            ...
                            "descriptive titles for conversations with Surgent. "
                            "Surgent is a helpful AI agent that can interact "
