# channel.bridge.llms.openai.completion
...
from channel.model.types.utils import EmbeddingResponse
...
from channel.bridge.llms.openai.openai import OpenAIConfig
