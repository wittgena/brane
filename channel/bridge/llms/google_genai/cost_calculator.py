# channel.bridge.llms.google_genai.cost_calculator
## @lineage: anchor.model.llms.gemini.cost_calculator
## @lineage: channel.llms.gemini.cost_calculator
## @lineage: gate.llms.gemini.cost_calculator
## @lineage: blm.llms.gemini.cost_calculator
## @lineage: gov.blm.llms.gemini.cost_calculator
"""
...
def cost_per_token(
    ...
    """
    from channel.model.cost.calculator.utils import generic_cost_per_token
...
def cost_per_web_search_request(usage: "Usage", model_info: "ModelInfo") -> float:
    ...
    """
    from channel.model.types.utils import PromptTokensDetailsWrapper
