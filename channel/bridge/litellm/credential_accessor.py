# channel.bridge.litellm.credential_accessor
## @lineage: bridge.litellm.credential_accessor
## @lineage: channel.litellm.credential_accessor
## @lineage: channel.bound.litellm.credential_accessor
## @lineage: gate.litellm.credential_accessor
