# channel.bridge.litellm.safe_json_loads
## @lineage: bridge.litellm.safe_json_loads
## @lineage: channel.litellm.safe_json_loads
## @lineage: channel.bound.litellm.safe_json_loads
