# channel.bridge.litellm.asyncify
## @lineage: bridge.litellm.asyncify
## @lineage: channel.litellm.asyncify
## @lineage: channel.bound.litellm.asyncify
## @lineage: gate.litellm.asyncify
## @lineage: gate.bound.core.asyncify
## @lineage: blm.bound.core.asyncify
## @lineage: blm.core.asyncify
## @lineage: blm.litellm_core_utils.asyncify
## @lineage: gov.blm.litellm_core_utils.asyncify
import asyncio
import functools
