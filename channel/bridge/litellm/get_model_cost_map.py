# channel.bridge.litellm.get_model_cost_map
## @lineage: bridge.litellm.get_model_cost_map
## @lineage: channel.litellm.get_model_cost_map
## @lineage: channel.bound.litellm.get_model_cost_map
## @lineage: gate.litellm.get_model_cost_map
## @lineage: gate.bound.core.get_model_cost_map
"""
