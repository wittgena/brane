# channel.bridge.litellm.safe_json_dumps
## @lineage: bridge.litellm.safe_json_dumps
## @lineage: channel.litellm.safe_json_dumps
## @lineage: channel.bound.litellm.safe_json_dumps
## @lineage: gate.litellm.safe_json_dumps
## @lineage: gate.bound.core.safe_json_dumps
## @lineage: blm.bound.core.safe_json_dumps
## @lineage: blm.core.safe_json_dumps
## @lineage: blm.litellm_core_utils.safe_json_dumps
## @lineage: gov.blm.litellm_core_utils.safe_json_dumps
import json
from typing import Any, Union

from pydantic import BaseModel

from bound.config.constants import DEFAULT_MAX_RECURSE_DEPTH
