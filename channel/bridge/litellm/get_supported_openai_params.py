# channel.bridge.litellm.get_supported_openai_params
## @lineage: bridge.litellm.get_supported_openai_params
## @lineage: channel.litellm.get_supported_openai_params
